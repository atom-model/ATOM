...
Print_Hydrosphere::Print_Hydrosphere ( int im, int jm, int km, int nm, int n, double time )
{
	this -> im = im;
	this -> jm = jm;
	this -> km = km;
...
Print_Hydrosphere::~Print_Hydrosphere() {}


void Print_Hydrosphere::printData ( Array &t, Array &u, Array &v, Array &w, Array &c )
{
	cout.precision ( 4 );
	cout.setf ( ios::fixed );
...
void Print_Hydrosphere::printIntro ( Array_1D &rad, Array_1D &the, Array_1D &phi )
{
	cout.precision ( 0 );
	cout.setf ( ios::fixed );
	...
	cout << "  r = i-direction consists of " << im;
