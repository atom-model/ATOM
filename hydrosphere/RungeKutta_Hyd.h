...
class RungeKutta_Hydrosphere
{
	...
	public:
		...
		void solveRungeKutta_3D_Hydrosphere( RHS_Hydrosphere &, int &, double, double, double, double, double, double, 
		...
		void solveRungeKutta_2D_Hydrosphere( RHS_Hydrosphere &, int &, Array_1D &, Array_1D &, Array_1D &, Array &, 
                                             Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, 
                                             Array &, Array &, Array & );
