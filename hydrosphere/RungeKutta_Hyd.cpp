...
// Runge-Kutta 4. order for k1 step ( dt )
				prepare.RK_RHS_3D_Hydrosphere ( i, j, k, L_hyd, g, cp_w, u_0, t_0, c_0, r_0_water, ta, pa, ca, rad, the, phi, h, t, u, v, w, p_dyn, c, tn, un, vn, wn, p_dynn, cn, rhs_t, rhs_u, rhs_v, rhs_w, rhs_c, aux_u, aux_v, aux_w, Salt_Finger, Salt_Diffusion, Buoyancy_Force, Salt_Balance, p_stat, r_water, r_salt_water );
