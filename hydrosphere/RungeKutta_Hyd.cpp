...
//				prepare.RK_RHS_Hydrosphere ( im-1, j, k, L_hyd, gr, cp_w, t_Boussinesq, u_0, tau, t_0, c_0, r_0_water, pa, ca, rad, the, phi, h, t, u, v, w, p, c, tn, un, vn, wn, cn, rhs_t, rhs_u, rhs_v, rhs_w, rhs_c, aux_u, aux_v, aux_w, Salt_Finger, Salt_Diffusion, Salt_Balance );
