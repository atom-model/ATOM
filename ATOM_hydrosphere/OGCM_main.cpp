...
// maximum number of outer pressure loop iterations ( pressure_iter_max and pressure_iter_max_2D )
	...
	int im = 41, jm = 181, km = 361, nm = 200, velocity_iter_max = 1, pressure_iter_max = 1;
	...
	const double c_Boussinesq = 1.;						// compares to 20°C, threshhold temperature for the Boussinesq-approximation concerning bouyancy effects
//	const double c_Boussinesq = 0.9686;						// compares to 20°C, threshhold temperature for the Boussinesq-approximation concerning bouyancy effects
//	const double ca = 0.9686;								// c = 0.9686 compares to a salinity of 33.9 psu, mean value, ca corresponds to ta
	const double ca = 0.;								// c = 0.9686 compares to a salinity of 33.9 psu, mean value, ca corresponds to ta
...
//	initial conditions for v and w velocity components at the sea surface close to east or west coasts, to close gyres
	oceanflow.IC_v_w_WestEastCoast ( h, u, v, w );
