...
// assumption of maximum depth of sea 6000 m compares to 40 steps times 150 m
	...
	i_beg = 32;				// compares to an ocean depth of 1950 m
...
void IC_Thermohalin::IC_v_w_WestEastCoast ( Array &h, Array &u, Array &v, Array &w )
{
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 0; j < jm; j++ )
		{
			for ( int k = 0; k < km; k++ )
			{
				if ( h.x[ i ][ j ][ k ] == 0. )
				{
					t.x[ i ][ j ][ k ] = ( t_j.y[ j ][ k ] - ta ) * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg ) + ta;
		...
		for ( int j = j_beg + j_run; j < ( j_beg + j_step + j_run ); j++ )
		{
			for ( int k = k_beg + k_run; k < ( k_beg + k_step + k_run ); k++ )
			{
				for ( int i = i_beg; i < im; i++ )
				{
					if ( h.x[ i ][ j ][ k ] != 1. )
					{
						v.x[ i ][ j ][ k ] = - 0.0008 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = - 0.0010 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
		k_run++;
		...
		for ( int j = 53; j < 59; j++ )
		{
			for ( int k = 234; k < 253; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					{
						v.x[ i ][ j ][ k ] = + 0.0;
						w.x[ i ][ j ][ k ] = + 0.001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
		}
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 63; j < 68; j++ )
		{
			for ( int k = 264; k < 284; k++ )
			{
				...
				{
					{
						v.x[ i ][ j ][ k ] = - 0.001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = - 0.00;
					}
				}
			}
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 38; j < 46; j++ )
		{
			for ( int k = 295; k < 306; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
//					u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					v.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					w.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				}
			}
		}
	}
		...
		for ( int j = ( j_end - j_run ); j > ( j_end - j_step - j_run ); j-- )
		{
			for ( int k = ( k_beg + k_run ); k < ( k_beg + k_step + k_run ); k++ )
			{
				for ( int i = i_beg; i < im; i++ )
				{
					if ( h.x[ i ][ j ][ k ] != 1. )
					{
						v.x[ i ][ j ][ k ] = - 0.0006 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = + 0.0010 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
		...
		for ( int j = 15; j < 32; j++ )
		{
			for ( int k = 310; k < 316; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					{
						v.x[ i ][ j ][ k ] = + 0.0;
						w.x[ i ][ j ][ k ] = - 0.0008 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
		}
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 26; j < 30; j++ )
		{
			for ( int k = 326; k < 348; k++ )
			{
				...
				{
					u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					v.x[ i ][ j ][ k ] = + 0.000 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					w.x[ i ][ j ][ k ] = - 0.001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				}
			}
		}
		...
		for ( int j = 32; j < 41; j++ )
		{
			for ( int k = 317; k < 328; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					...
					u.x[ i ][ j ][ k ] = - 0.00001 * IC_water;
//					v.x[ i ][ j ][ k ] = - 0.040 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
//					w.x[ i ][ j ][ k ] = - 0.010 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					v.x[ i ][ j ][ k ] = + 0.0005 * IC_water;
					w.x[ i ][ j ][ k ] = + 0.000 * IC_water;
				}
			}
		}
	}
		...
		for ( int j = ( j_end - j_run ); j > ( j_end - j_step - j_run ); j-- )
		{
			for ( int k = ( k_beg + k_run ); k < ( k_beg + k_step + k_run ); k++ )
			{
				for ( int i = i_beg; i < im; i++ )
				{
					if ( h.x[ i ][ j ][ k ] != 1. )
					{
						v.x[ i ][ j ][ k ] = 0.0005 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = - 0.0010 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
...
/*
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 50; j < 57; j++ )
		{
			...
			{
				v.x[ i ][ j ][ k ] = + 0.;
				w.x[ i ][ j ][ k ] = + 0.015 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
			}
		}
	}
*/
...
// Nord-Süd, Oststrang                                                         from k=195 until k=200 compares to 165°W until 160°W )
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 27; j < 51; j++ )
		{
			...
			{
				v.x[ i ][ j ][ k ] = + 0.001 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				w.x[ i ][ j ][ k ] = + 0.00 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
			}
		}
	}
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 60; j < 81; j++ )
		{
			for ( int k = 92; k < 108; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					v.x[ i ][ j ][ k ] = + 0.0015 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					w.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				}
			}
		}
	}
		...
		for ( int j = 40; j < 54; j++ )
		{
			for ( int k = 116; k < 130; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					...
					{
						v.x[ i ][ j ][ k ] = - 0.0008 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = - 0.0015 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						l++;
					}
				}
			if ( h.x[ i ][ j ][ k ] == 1. ) l = 1;
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 80; j < 98; j++ )
		{
			for ( int k = 125; k < 136; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					v.x[ i ][ j ][ k ] = + 0.0007 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					w.x[ i ][ j ][ k ] = - 0.0007 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				}
			}
		}
	}
	...
	for ( int i = im-4; i < im; i++ )
	{
		for ( int j = 0; j < 31; j++ )
		{
			for ( int k = 180; k < 195; k++ )
			{
				...
				{
					v.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					w.x[ i ][ j ][ k ] = - 0.0003 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
				}
			}
		}
	}
	...
	for ( int i = 10; i < im-6; i++ )
	{
		for ( int j = 147; j < 153; j++ )
		{
			for ( int k = 0; k < km; k++ )
			{
				...
				{
//					c.x[ i ][ j ][ k ] = 1.00;
//					v.x[ i ][ j ][ k ] = - 0.000 * IC_water * ( double ) ( i - 5 ) / ( double ) ( im-2 - 5 );
//					w.x[ i ][ j ][ k ] = 0.0010 * IC_water * ( double ) ( i - 5 ) / ( double ) ( im-2 - 5 );
					v.x[ i ][ j ][ k ] = - 0.000 * IC_water;
					w.x[ i ][ j ][ k ] = 0.0010 * IC_water;
				}
			}
		}
	}
	...
	for ( int i = i_beg+10; i < im; i++ )
	{
		for ( int j = 144; j < 147; j++ )
		{
			for ( int k = 0; k < km; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
//					v.x[ i ][ j ][ k ] = - 0.000 * IC_water * ( double ) ( i - i_beg + 5 ) / ( double ) ( i_max - i_beg + 5 );
					w.x[ i ][ j ][ k ] = 0.0005 * IC_water * ( double ) ( i - i_beg + 5 ) / ( double ) ( i_max - i_beg + 5 );
				}
			}
		}
	}
		...
		for ( int j = ( j_end - j_run ); j > ( j_end - j_step - j_run ); j-- )
		{
			for ( int k = ( k_beg + k_run ); k < ( k_beg + k_step + k_run ); k++ )
			{
				for ( int i = 10; i < im; i++ )
				{
					...
					{
//						v.x[ i ][ j ][ k ] = + 0.000 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
						w.x[ i ][ j ][ k ] = - 0.0002 * IC_water * ( double ) ( i - i_beg ) / ( double ) ( i_max - i_beg );
					}
				}
			}
		k_run = k_run+1;
	...
	for ( int i = im-14; i < im-2; i++ )
	{
		for ( int j = 87; j < 94; j++ )
		{
			for ( int k = 265; k < 271; k++ )
			{
				...
				{
					{
						u.x[ i ][ j ][ k ] = + 0.0002 * IC_water;
						w.x[ i ][ j ][ k ] = - 0.0001 * IC_water;
					}
				}
			}
		}
	...
	for ( int i = i_EIC_u; i < i_EIC_o; i++ )
	{
		for ( int j = 88; j < 93; j++ )
		{
			for ( int k = 145; k < 271; k++ )
			{
				...
				{
					v.x[ i ][ j ][ k ] = 0.;
					w.x[ i ][ j ][ k ] = - 0.001 * IC_water * ( double ) ( i - i_EIC_u ) / ( double ) ( i_EIC_o - i_EIC_u );
				}
			}
		}
	}
	...
	for ( int i = i_SCC_u; i < i_SCC_o; i++ )
	{
		for ( int j = 86; j < 88; j++ )
		{
			for ( int k = 135; k < 271; k++ )
			{
				...
				{
					v.x[ i ][ j ][ k ] = 0.;
					w.x[ i ][ j ][ k ] = 0.0008 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_SCC_o - i_SCC_u );
				}
			}
		}
	}
	...
	for ( int i = i_SCC_u; i < i_SCC_o; i++ )
	{
		for ( int j = 93; j < 95; j++ )
		{
			for ( int k = 165; k < 271; k++ )
			{
				...
				{
					v.x[ i ][ j ][ k ] = 0.;
					w.x[ i ][ j ][ k ] = 0.0004 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_SCC_o - i_SCC_u );
				}
			}
		}
	}
	...
	for ( int i = i_ECC_u; i < i_ECC_o; i++ )
	{
		for ( int j =83; j < 88; j++ )
		{
			for ( int k = 135; k < 271; k++ )
			{
				...
				{
					v.x[ i ][ j ][ k ] = 0.;
					w.x[ i ][ j ][ k ] =  + 0.001 * IC_water * ( double ) ( i - i_ECC_u ) / ( double ) ( i_ECC_o - i_ECC_u );
				}
			}
		}
	}
	...
	for ( int i = i_SCC_u; i < i_ECC_o - 1; i++ )
	{
		for ( int j = 83; j < 88; j++ )
		{
			for ( int k = 265; k < 276; k++ )
			{
				...
				{
					{
						u.x[ i ][ j ][ k ] = + 0.0002 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
						v.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
//						w.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
					}
				}
			}
		}
	...
	for ( int i = i_SCC_u; i < i_ECC_o - 1; i++ )
	{
		for ( int j = 84; j < 88; j++ )
		{
			for ( int k = 340; k < 345; k++ )
			{
				...
				{
					{
						u.x[ i ][ j ][ k ] = + 0.001 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
						v.x[ i ][ j ][ k ] = - 0.001 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
//						w.x[ i ][ j ][ k ] = + 0.0015 * IC_water * ( double ) ( i - i_SCC_u ) / ( double ) ( i_ECC_o - 1 - i_SCC_u );
					}
				}
			}
		}
	...
	for ( int i = i_deep; i < im; i++ )
	{
		for ( int j = 32; j < 37; j++ )
		{
			for ( int k = 317; k < 328; k++ )
			{
				...
				{
//					c.x[ i ][ j ][ k ] = 1.00;
					u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
//					v.x[ i ][ j ][ k ] = + 0.0015 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_deep - i_deep );
//					w.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_deep - i_deep );
				}
			}
		}
	}
	...
	for ( int i = i_bottom; i < i_deep + 1; i++ )
	{
		for ( int j = 32; j < 51; j++ )
		{
			for ( int k = 317; k < 328; k++ )
			{
				...
				{
//					c.x[ i ][ j ][ k ] = 1.00;
//					u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					v.x[ i ][ j ][ k ] = + 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					w.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
		}
	}
...
//						u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						v.x[ i ][ j ][ k ] = + 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						w.x[ i ][ j ][ k ] = - 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					}
				}
			}
		k_run++;
	...
	for ( int i = 0; i < i_beg; i++ )
	{
		for ( int j = 107; j < 112; j++ )
		{
			for ( int k = 273; k < 299; k++ )
			{
				if ( h.x[ i ][ j ][ k ] != 1. )
				{
					v.x[ i ][ j ][ k ] =   0.005 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					w.x[ i ][ j ][ k ] =   0.020 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
		}
	}
...
//					u.x[ i ][ j ][ k ] = - 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					v.x[ i ][ j ][ k ] = + 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					w.x[ i ][ j ][ k ] = + 0.000 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
		}
	}
...
//					c.x[ i ][ j ][ k ] = 1.00;
//					u.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					v.x[ i ][ j ][ k ] = - 0.0050 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					v.x[ i ][ j ][ k ] = - 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					w.x[ i ][ j ][ k ] = - 0.000 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
...
//					c.x[ i ][ j ][ k ] = 1.00;
//					u.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					v.x[ i ][ j ][ k ] = - 0.000 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					w.x[ i ][ j ][ k ] = - 0.0050 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					w.x[ i ][ j ][ k ] = - 0.0010 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
		}
...
//					c.x[ i ][ j ][ k ] = 1.00;
					u.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					v.x[ i ][ j ][ k ] = - 0.0050 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					v.x[ i ][ j ][ k ] = - 0.0002 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
//					w.x[ i ][ j ][ k ] = + 0.000 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
				}
			}
		}
...
//					c.x[ i ][ j ][ k ] = 1.00;
					u.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
//					v.x[ i ][ j ][ k ] = + 0.0015 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
//					w.x[ i ][ j ][ k ] = + 0.0030 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
					w.x[ i ][ j ][ k ] = + 0.0002 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
				}
			}
		}
	}
...
//					c.x[ i ][ j ][ k ] = 1.00;
					u.x[ i ][ j ][ k ] = + 0.0001 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
//					v.x[ i ][ j ][ k ] = + 0.0015 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
//					w.x[ i ][ j ][ k ] = - 0.0005 * IC_water * ( double ) ( i - i_deep ) / ( double ) ( i_max - i_deep );
				}
			}
		}
	}
	...
	for ( int i = 0; i < im; i++ )
	{
		for ( int j = 84; j < 90; j++ )
		{
			for ( int k = 78; k < 83; k++ )
			{
				{
					{
						u.x[ i ][ j ][ k ] = + 0.001 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						v.x[ i ][ j ][ k ] = + 0.003 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						w.x[ i ][ j ][ k ] = + 0.030 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					}
				}
			}
		}
	...
	for ( int i = i_beg; i < im; i++ )
	{
		for ( int j = 84; j < 97; j++ )
		{
			for ( int k = 82; k < 86; k++ )
			{
				{
					{
						v.x[ i ][ j ][ k ] = + 0.030 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						w.x[ i ][ j ][ k ] = - 0.005 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					}
				}
			}
		}
	...
	for ( int i = 0; i < i_beg; i++ )
	{
		for ( int j = 89; j < 133; j++ )
		{
			for ( int k = 74; k < 79; k++ )
			{
				{
					{
						v.x[ i ][ j ][ k ] = - 0.025 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
						w.x[ i ][ j ][ k ] = - 0.002 * IC_water * ( double ) ( i - i_bottom ) / ( double ) ( i_deep - i_bottom );
					}
				}
			}
		}
