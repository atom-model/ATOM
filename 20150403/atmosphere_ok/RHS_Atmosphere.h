...
class RHS_Atmosphere
{
	private:
		...
		double re, pr, ec, sc_WaterVapour, sc_CO2, gr, omega, coriolis, centrifugal, WaterVapour, buoyancy, CO2, p_h, E_Rain_SL, E_Rain, E_Rain_super, E_Ice, e_SL, Evaporation_Haude;
		double h_level, h_h, p_SL, q_h;
		double e_h, t_tau_h, a_h, sat_Deficit, RF_e, RF_c, a_SL, q_SL;
		...
		double RS_buoyancy_Energy_Rain, RS_buoyancy_Energy_Ice, RS_buoyancy_Energy_co2, RS_buoyancy_Momentum_Rain, RS_buoyancy_Momentum_Ice, RS_buoyancy_Momentum_co2; 
		...
		double sinthe, sinthe2, kro, lv, ls, ep, hp, coeff_lv, coeff_ls, p_0, p_0_vapour, r_0, t_0, t_Celsius, t_Celsius_SL, t_tau_SL, t_Boussinesq, cp_l, R_Air, R_WaterVapour, dqdr, dqdthe, dqdphi, dpdr_c, dpdthe_c, dpdphi_c, dpdr_co2, dpdthe_co2, dpdphi_co2;
	...
	public:
		...
		void RK_RHS_Atmosphere ( int, int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, Array_1D &, Array_1D &, Array_1D &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void RK_RHS_2D_Atmosphere ( int, int, Array_1D &, Array_1D &, Array_1D &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );
};
#endif
