...
class BC_Bathymetry_Atmosphere
{
	private:
		...
		double d_i, d_i_max, d_j, d_j_halb, d_j_max, d_k_halb, d_k_max, t_0, t_coeff, t_pol, t_tropopause, t_equator, t_12, p_0, p_0_dampf, c_tropopause, c_equator, c_coeff, c_pol, ep, hp, p_h; 
	...
	public:
		...
		void BC_SolidGround ( int, double, double, double, double, double, double, double, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array_2D &, Array_2D &, Array_2D &, Array_2D & );
