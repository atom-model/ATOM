...
#            ('verbose', '', 'bool', False),
        ...
        'atmosphere': [
            ...
            ('t_tropopause', 'temperature in the tropopause, t = 0.78 compares to -60.093°C compares to 213,057 K', 'double', 0.733),
            ('t_land', 'temperature increase on land by 5°C ( 5°C compares to t_land = 0.018305 )', 'double', 0.003661),

            ('c_tropopause', 'minimum water vapour at tropopause c_tropopause = 0.01429 compares to 0.05 g/kg', 'double', 0.0),
            ('c_land', 'water vapour reduction on land ( 90% of the saturation value )', 'double', 0.5),
