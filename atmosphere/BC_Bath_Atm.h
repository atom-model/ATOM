...
class BC_Bathymetry_Atmosphere
{
	...
	public:
		...
		void BC_SolidGround ( int, int, int *, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array_2D & );
