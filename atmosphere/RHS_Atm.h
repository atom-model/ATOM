...
class RHS_Atmosphere
{
	private:
		...
		// double t_tau_h;
		double t_Celsius;
		// double t_Celsius_ni, t_Celsius_pi, t_Celsius_nj, t_Celsius_pj, t_Celsius_nk, t_Celsius_pk, dp_hdr, dp_hdthe, dp_hdphi;
		// double h_level, h_h, sat_Deficit, RF_e, RF_c, Evaporation_Haude;
		// double a2, dt2;
		double dr2, dthe2, dphi2, rm2;
		// double kr1, kr2, kthe1, kthe2;
		double rm, c43, c13;
		...
		// double q_i_plus, q_i_minus, q_j_plus, q_j_minus, q_k_plus, q_k_minus;
		double q_Rain;
		// double q_Rain_super;
		double q_Ice;
		double sinthe, sinthe2;
		// double kro, lv, ls, ep, hp;
		double coeff_lv, coeff_ls, coeff_lf;
		// double p_0, p_in_vapour, r_0, t_0, cp_l, R_Air, R_WaterVapour, dqdr, dqdthe, dqdphi, dpdr_c, dpdthe_c, dpdphi_c, dpdr_co2_, dpdthe_co2_, dpdphi_co2_;
		double costhe, cotthe, rmsinthe, rm2sinthe, rm2sinthe2;
		// double rmtanthe;
		// double resra, resre, dummy_1, dummy_2, dummy_3;
		double k_Force;
		double dudr, dudthe, dudphi, dvdr, dvdthe, dvdphi, dwdr, dwdthe, dwdphi;
		// double drdr, drdthe, drdphi, E_dEdr_Rain, E_dEdr_Rain_super, E_dEdr_Ice, E_dEdthe_Rain, E_dEdthe_Rain_super, E_dEdthe_Ice, E_dEdphi_Rain, E_dEdphi_Rain_super, E_dEdphi_Ice, dRaindr, dRaindthe, dRaindphi, dRain_superdr, dRain_superdthe, dRain_superdphi, dIcedr, dIcedthe, dIcedphi;
		double d2udr2, d2udthe2, d2udphi2, d2vdr2, d2vdthe2, d2vdphi2, d2wdr2, d2wdthe2, d2wdphi2;
		// double d2rdr2, d2rdthe2, d2rdphi2;
		...
		// double d_i, d_i_max, t_tropopause, j_half, d_j_half, trop_co2_eff, d_j, i_max, i_beg;
		double gam, sigma;
		double alf_ev;
		...
		// double eps_u, delta_i_c, K_p, del_u, cloud_u, c_u;
