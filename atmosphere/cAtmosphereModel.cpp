...
void cAtmosphereModel::RunTimeSlice ( int Ma )
{
    ...
    int *im_tropopause = new int [ jm ];// location of the tropopaus
    ...
    if ( RadiationModel == 1 ){
        circulation.BC_Radiation_multi_layer ( im_tropopause, t_cretaceous, n, CO2, albedo, epsilon, precipitable_water, 
