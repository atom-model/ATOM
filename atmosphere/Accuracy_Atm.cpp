...
double Accuracy::steadyQuery_3D ( int &i_u, int &j_u, int &k_u, int &i_v, int &j_v, int &k_v, int &i_w, int &j_w, int &k_w, int &i_t, int &j_t, int &k_t, int &i_c, int &j_c, int &k_c, int &i_cloud, int &j_cloud, int &k_cloud, int &i_ice, int &j_ice, int &k_ice, int &i_co2, int &j_co2, int &k_co2, int &i_p, int &j_p, int &k_p, double &min_u, double &min_v, double &min_w, double &min_t, double &min_c, double &min_cloud, double &min_ice, double &min_co2, double &min_p, Array &u, Array &un, Array &v, Array &vn, Array &w, Array &wn, Array &t, Array &tn, Array &c, Array &cn, Array &cloud, Array &cloudn, Array &ice, Array &icen, Array &co2, Array &co2n, Array &p_dyn )
{
...
// printout of maximum and minimum absolute and relative errors of the computed values at their locations while iterating
	...
	switch ( choice )
	{
		...
		case 10 :	name_Value = " dco2: CO2 transport equation ";
						Value = min_co2;
						i_loc = i_co2;
						j_loc = j_co2;
						k_loc = k_co2;
