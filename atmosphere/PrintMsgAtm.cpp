...
void cAtmosphereModel::print_min_max_atm(){
    ...
    cout << endl << " energies at see level without convection influence: " 
        << endl << endl;
/*
    searchMinMax_2D(" max 2D Q radiation ", " min 2D Q radiation ", 
        "W/m2", Q_radiation, 1.0);
    searchMinMax_2D(" max 2D Q latent ", " min 2D Q latent ", 
        "W/m2", Q_latent, 1.0);
    searchMinMax_2D(" max 2D Q sensible ", " min 2D Q sensible ", 
        "W/m2", Q_sensible, 1.0);
*/
