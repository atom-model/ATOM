...
class Results_MSL_Atm
{
	private:
		...
		double i_level, h_level, h_h, sat_deficit, RF_e, RF_c, Evap_Haude, Evaporation_Penman_average, Evaporation_Haude_average, co2_average;
		double ep, hp, u_0, p_0, t_0, c_0, co2_0, sigma, albedo_extra, lv, ls, cp_l, r_air, dt, dr, ozean_land, p_baro, L_atm, c13, c43;
		double R_Air, r_h, r_water, r_water_vapour, R_WaterVapour, precipitablewater_average, precipitation_average, precipitation_NASA_average, co2_vegetation_average;
		...
		double Value_1, Value_2, Value_3, Value_4, Value_5, Value_6, Value_7, Value_8, Value_9, Value_10, Value_12, Value_13, Value_14, Value_15, Value_16, Value_17, Value_18, Value_19;
