...
class Results_MSL_Atm
{
	private:
		...
		// double E_Rain_super_SL, E_Ice_SL, q_Rain_SL, q_Rain_super_SL, q_Ice_SL;
		...
		double Value_12;
		// double Value_13;
		double Value_14, Value_15, Value_16, Value_17, Value_18, Value_19;
		// double rm, rmsinthe, sinthe
		double dthe, dphi;
		// double dtdthe, dtdphi;
		double alf_ev;
		// double alf_dep, eps_T;
		// double S_c_c, S_au;
		...
		// double MC_s, MC_q_v, MC_v, MC_w, s, cu, C_p, u_b, u_d1, w_d1, w_d, v_d1, v_d, q_v_d1, q_v_d, s_d1, s_d, u_u1, w_u1, w_u, v_u1, v_u, q_v_u1, q_v_u
		double q_v_b, q_i_b;
		// double q_c_u1, q_c_u, q_c_d;
		double q_c_b;
		// double s_u1, s_u, M_d, E_d, D_d, M_u, E_u, D_u, r_dry_parc, r_humid_parc, a_w, b_w, a_i, b_i;
		// double a_u, a_d;
		double b_u, alf_1, alf_2, p_ps, bet_p;
		// double eps_u, delta_i_c, K_p, del_u, cloud_u, dt_u
		double t_u;
		// double buoyancy_check, u_u1_check, u_d1_check, sat_check, u_max_check, t_b, s_b, c_b, cloud_b, v_b, w_b, gam_d, dcdr, dcdthe, dcdphi, eps_d, del_d;
		double T, T_nue, T_tilda_h;
		// double t_Celsius_ni, t_Celsius_pi, E_dEdr_Rain, E_dEdr_Ice, T_p, T_n, p_h_p, p_h_n, p_v_sw_p, p_v_sw_n, q_v_sw_p, q_v_sw_n, dq_v_swdT, p_v_0, p_v_hyp
		double q_v_hyp, q_v_hyp_n;
		// double p_v_sw, q_v_sw, dq_v_sidT, p_v_si, q_v_si, Rd_Rv, Rd_Rv_1
		double T_t_in;
		// double T_b_w, T_t_in_T_b_w, dp_v_swdT, T_b_i, T_t_in_T_b_i, dp_v_sidT, dp_dT, p_denom, p_nom;
		double T_t_in0, T_t_in1, DEP, CND,d_q_v, d_q_c, d_q_i, d_t, p_t_in, t_Celsius_0, E_Rain_t_in, q_Rain_t_in, t_pole, t_cretaceous;
		// double t_north_pole_av, t_south_pole_av;
	...
	public:
		...
		void run_MSL_data ( int, int, int, Array_1D &, Array_1D &, Array_1D &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array &, Array &, Array &, Array &, Array & );
