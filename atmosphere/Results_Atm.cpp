...
*/
            ...
            if(is_land(h, 0, j, k)){
                ...
                BuoyancyForce.x[0][j][k] = BuoyancyForce.x[i_mount][j][k];
                CoriolisForce.x[0][j][k] = CoriolisForce.x[i_mount][j][k];
                PressureGradientForce.x[0][j][k] = PressureGradientForce.x[i_mount][j][k];
            }
        }
    }
    for(int k = 0; k < km; k++){
