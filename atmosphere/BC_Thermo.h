...
class BC_Thermo
{
	private:
		// int i;
		int j, k, im, jm, km, k_half, j_half, i_half, i_max, j_max, k_max, i_beg, im_1;
		// int i_land;
		int iter_rad;
		...
		double d_k_half, d_k_max, t_eff_earth;
		// double r;
		double rad_bal_minus; 
		double dummy_1, dummy_2, dummy_3;
		// double ca;
		double ua_00, ua_30, ua_60, ua_90;
		// double u_co2_eff, u_end;
		...
		double g, ep, hp, u_0, p_0, t_0, c_0, co2_0, sigma, albedo_extra, cp_l, r_air;
		// double ozean_land;
		double L_atm, c13, c43;
		double R_Air;
		// double r_h;
		double r_water_vapour, R_WaterVapour;
		// double precipitablewater_average, precipitation_average, precipitation_NASA_average;
		double ik;
		// double eps;
		double epsilon_extra, c_ocean, c_land, t_average, co2_average, co2_pole, gam, t_Ik, Ik_loss, Ik_tot;
		...
		double e_h, a_h, p_h, q_h;
		// double t_tau_h;
		double t_Celsius, t_Celsius_ni, t_Celsius_pi, t_Celsius_nj, t_Celsius_pj, t_Celsius_nk, t_Celsius_pk, dp_hdr, dp_hdthe, dp_hdphi;
		double sinthe, sinthe2, lv, ls, coeff_lv, coeff_ls;
		// double r_0, dqdr, dqdthe, dqdphi, dpdr_c, dpdthe_c, dpdphi_c, dpdr_co2_, dpdthe_co2_, dpdphi_co2_;
		// double dudr, dudthe, dudphi, dvdr, dvdthe, dvdphi, dwdr, dwdthe, dwdphi, drdr, drdthe, drdphi;
		double E_dEdr_Rain, E_dEdr_Rain_super, E_dEdr_Ice, E_dEdthe_Rain, E_dEdthe_Rain_super, E_dEdthe_Ice, E_dEdphi_Rain, E_dEdphi_Rain_super, E_dEdphi_Ice;
		// double dRaindr, dRaindthe, dRaindphi, dRain_superdr, dRain_superdthe, dRain_superdphi, dIcedr, dIcedthe, dIcedphi;
		// double dt;
		double dr, dthe, dphi;
		// double dt2;
		...
		// double E, E_Rain_SL;
		double E_Rain, E_Rain_super, E_Ice, q_Rain, q_Rain_super, q_Ice;
		...
		double t_equator, t_tropopause, t_co2_eff, t_pole;
		// double c_equator;
		double c_tropopause;
		// double co2_equator;
		double co2_tropopause, co_co2_eff;
		// double co_pol;
		double co2_vegetation, co2_ocean, co2_land, co2_cretaceous;
