...
class BC_Thermo
{
	private:
		...
		int max_ch, min_ch, max_cm, min_cm, max_cl, min_cl, iter_prec; 
		...
		double r_dry, r_humid, p_SL, t_SL, bet_SL;
		double t_1, T_t_0, T_t_00, T_t_01, q_T, q_Rain_n;
	...
	public:
		...
		void BC_Radiation_two_layer ( int *, double, double, double, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array &, Array &, Array &, Array &, Array &, Array & );

		void BC_Radiation_multi_layer ( int, int *, double, double, double, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void BC_Radiation_parabolic ( Array_2D &, Array & );

		void BC_WaterVapour ( int *, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array_2D & );
