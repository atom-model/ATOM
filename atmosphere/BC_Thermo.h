...
class BC_Thermo
{
	...
	public:
		...
		void IC_CellStructure ( int, int, double, Array &, Array &, Array & );

		void IC_v_w_WestEastCoast ( Array &, Array &, Array &, Array & );

		void BC_Temperature ( int, int, int, int, int, int, int, int, int, double, double, double, double, double, double, double, double, double, double, double, Array_2D &, Array &, Array &, Array & );

		void TropopauseLocation ( int, int );

		void BC_RadiationBalance_comp ( double, double, double, double, double, double, double, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array & );

		void BC_RadiationBalance_parab ( double, double, double, double, double, Array_2D &, Array & );

		void BC_WaterVapour ( int, int, double, double, double, double, double, double, double, double, Array_2D &, Array &, Array &, Array &, Array &, Array_2D &, Array_2D & );

		void BC_CO2 ( int, int, int, double, double, double, double, double, double, double, double, double, double, Array_2D &, Array_2D &, Array &, Array &, Array &, Array & );
