...
{
	private:
		int n, im, jm, km, l_anf, l_end, velocity_iter_2D, pressure_iter_2D, velocity_iter, pressure_iter, Ma;
	...
	public:
		...
		double steadyQuery_3D ( int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double &, double &, double &, double &, double &, double &, double &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void iterationPrintout_3D ( int &, int &, int &,int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double &, double &, double &, double &, double &, double &, double & );
