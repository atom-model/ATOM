...
void BC_Thermo::BC_Radiation_multi_layer ( int *im_tropopause, double t_cretaceous, double CO2, Array_2D &albedo, Array_2D &epsilon, Array_2D &precipitable_water, Array_2D &radiation_surface, Array_2D &Q_radiation, Array_2D &Q_latent, Array_2D &Q_sensible, Array_2D &Q_bottom, Array_2D & co2_total, Array &p_stat, Array &t, Array &c, Array &h, Array &epsilon_3D, Array &radiation_3D, Array &cloud, Array &ice, Array &co2 )
{
	...
	for ( int j = 0; j < jm; j++ )
	{
		...
		for ( int k = 0; k < km; k++ )
		{
			...
			for ( int i = 0; i <= i_trop; i++ )
			{
				...
				if ( CO2 == 1. )			co2_coeff = co2_factor * ( co2_equator / co2_tropopause );					// influence of co2 in the atmosphere, co2_coeff = 1. means no influence
				else 							co2_coeff = 1.;
...
void BC_Thermo::BC_Temperature ( int *im_tropopause, double &t_cretaceous, double &t_cretaceous_prev, Array_2D &temperature_NASA, Array &h, Array &t, Array &p_dyn, Array &p_stat )
{
...
void BC_Thermo::BC_NASAbasedSurfTempRead ( int &Ma_prev, double &t_cretaceous_prev, Array &t, Array &c, Array &cloud, Array &ice )
{
    string NASAbasedSurfaceTemperature_File = output_path + "/" + std::to_string( Ma_prev ) + "Ma_NASAbasedSurfaceTemperature.xyz";
	...
	Name_NASAbasedSurfaceTemperature_File_Read >> Ma_prev;
	Name_NASAbasedSurfaceTemperature_File_Read >> t_cretaceous_prev;
...
void BC_Thermo::BC_NASAbasedSurfTempWrite ( int &Ma_prev, double &t_cretaceous_prev, Array &t, Array &c, Array &cloud, Array &ice )
{
// initial conditions for the Name_NASAbasedSurfaceTemperature_File at the sea surface
	...
	Name_NASAbasedSurfaceTemperature_File_Write << Ma_prev << endl << t_cretaceous_prev << endl;
