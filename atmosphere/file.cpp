...
//    double cloud_max_equator = 0.004;  // for Humility_critical approach
//    double cloud_max_equator = 0.001;  // for Humility_critical approach
    double cloud_max_equator = 4.0; // for Agnesi approach
    double cloud_max_pole = 1.0; // for Agnesi approach

//    double ice_max_equator = 0.001;  // for Humility_critical approach
//    double ice_max_pole = 0.0001;  // for Humility_critical approach
        ...
        for(int k = 0; k < km; k++){
            ...
            for(int i = 0; i < im; i++){
                ...
                if((is_land(h, 0, j, k))&&(i == 0)){
                    co2.x[0][j][k] = co2.x[i_mount+1][j][k];
                }
            }
        }
    }
