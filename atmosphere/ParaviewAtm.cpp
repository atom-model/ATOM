...
void cAtmosphereModel::paraview_vtk_radial(string &Name_Bathymetry_File, 
    ...
    for(int k = 0; k < km; k++){
        for(int j = 0; j < jm; j++){
            ...
            temp_reconst.y[j][k] = temp_reconst.y[j][k] * t_0 - t_0;
...
void cAtmosphereModel::paraview_vtk_zonal(string &Name_Bathymetry_File, 
    ...
    dump_zonal("i_Base", aux_u, 1., k_zonal, Atmosphere_vtk_zonal_File);
    dump_zonal("i_LFS", aux_v, 1., k_zonal, Atmosphere_vtk_zonal_File);
