...
class Results_MSL_Atm
{
	private:
		...
		double ep, hp, u_0, p_0, t_0, c_0, sigma, albedo, lv, cp_l, r_0_air, dr, dthe, dphi, ozean_land, p_baro, L_atm;
		double p_h, e_h, a_h, R_Air, r_h, r_0_water_vapour, R_WaterVapour, coeff_lv, alfa;
		...
		double rm, sinthe, rmsinthe, dcdr, dcdthe, dcdphi;

		Array				hc ( int, int, int, double ), Rai ( int, int, int, double ), Rai_su ( int, int, int, double ), Ic ( int, int, int, double ), Lat ( int, int, int, double ), cond_3D ( int, int, int, double ), evap_3D ( int, int, int, double ), cc ( int, int, int, double ), tc ( int, int, int, double ), pc ( int, int, int, double ), vc ( int, int, int, double ), wc ( int, int, int, double );
	...
	public:
		...
		Array_1D		radc ( int, double ), thec ( int, double );

		~Results_MSL_Atm (  );

		void run_MSL_data ( Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_2D &, Array_1D &, Array_1D & );
