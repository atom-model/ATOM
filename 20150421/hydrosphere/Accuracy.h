...
class Accuracy
{
	private:
		...
		double residuum_alt, min, min_u, min_v, min_w, min_t, min_c, min_p;
		double Value, L_hyd;
	...
	public:
		...
		double steadyQuery ( int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double &, double &, double &, double &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void iterationPrintout ( int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double &, double &, double &, double & );

		double residuumQuery_2D ( int &, int &, double &, Array_1D &, Array_1D &, Array &, Array & );

		double steadyQuery_2D ( int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double &, Array &, Array &, Array &, Array &, Array &, Array & );

		void iterationPrintout_2D ( int &, int &, int &,int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, int &, double &, double &, double & );
