...
class IC_Thermohalin
{
	...
	public:
		...
		void IC_South_Polar_Sea ( Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_DeepWater ( Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_v_w_Atmosphere ( Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_v_w_WestEastCoast ( Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_v_w_Ekman ( Array &, Array &, Array &, Array &, Array & );

		void BC_Temperature_Salinity ( int, int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, Array_2D &, Array_2D &, Array_2D &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_Atlantischer_Ozean ( Array &, Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_Indischer_Ozean ( Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_Pazifischer_Ozean ( Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_Nord_Polar_Meer ( Array &, Array &, Array &, Array &, Array &, Array &, Array & );

		void IC_EquatorialCurrents ( Array &, Array &, Array &, Array &, Array &, Array &, Array & );
