...
print('\n\n\n')
print('     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   General Circulation Model %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n') 
print('\n')
print('\n' + ' ... run_py: date and time at run time begin: \n' 
...
if __name__ == "__main__":
    ...
    print('\n')
    print('\n' + ' ... run.py: date and time at run time end: \n' 
        + ' ... {0}'.format(end_time_computer))
    print('\n' + ' ... run.py: duration of run time in hours, minutes and seconds:     {}'
