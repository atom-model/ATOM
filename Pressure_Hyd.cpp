...
void Pressure_Hyd::computePressure_3D ( double pa, Array_1D &rad, Array_1D &the, Array &p_dyn, Array &aux_p, Array &h, Array &rhs_u, Array &rhs_v, Array &rhs_w, Array &aux_u, Array &aux_v, Array &aux_w )
{
...
void Pressure_Hyd::computePressure_2D ( double pa, Array_1D &rad, Array_1D &the, Array &p_dyn, Array &aux_p, Array &h, Array &rhs_v, Array &rhs_w, Array &aux_v, Array &aux_w )
{
// Pressure using Euler equation ( 2. derivative of pressure added to the Poisson-right-hand-side )
	dr2 = dr * dr;
	dthe2 = dthe * dthe;
